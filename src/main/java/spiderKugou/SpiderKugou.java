...
//		}
		...
		String content = connect.connect("https://www.jianshu.com/p/c3eece48fe52", "utf-8");


		HtmlManage html = new HtmlManage();

		Document doc = html.manage(content);
		Element ele = doc.getElementsByAttributeValue("name", "description").get(0);
		String attr = ele.attr("content");
		String res = StringUtils.substringBetween(attr, "“", "”");
